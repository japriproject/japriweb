    ...
    <div className="flex flex-col min-h-screen bg-slate-50 safe-pb">
      ...
      <div className="gradient-primary px-5 pt-12 pb-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-xl font-bold">Promo & Penawaran</h1>
          <p className="text-white/60 text-sm mt-0.5 font-medium">Dapatkan penawaran terbaik</p>
        </div>
      </div>

      {/* Under Construction */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 text-center space-y-4">
        <div className="w-20 h-20 bg-gradient-to-br from-pink-400 to-rose-500 rounded-3xl flex items-center justify-center shadow-lg shadow-rose-500/30 animate-pulse">
          <Sparkles size={40} className="text-white" />
        </div>
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Sedang Dikerjakan</h2>
          <p className="text-gray-500 text-sm mt-2 leading-relaxed">
            Fitur Promo & Penawaran sedang dalam tahap pengembangan.
          </p>
        </div>
      </div>
