...
import { Wifi, CheckCircle2, Loader2, AlertCircle, ShieldCheck, ChevronDown, Phone } from 'lucide-react'
...
export default function PaketDataPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 safe-pb">
      <MobileTopBar title="Paket Data" subtitle="Internet cepat & hemat" accent="blue"
        trailing={<span className="rounded-full bg-blue-50 px-3 py-2 text-xs font-bold text-blue-700">{formatRupiah(saldo)}</span>} />
