...
import {
  ...
  MonitorSmartphone, Building2, Waves, HeadsetIcon, UserPlus, QrCode
} from 'lucide-react'
      ...
      <div className="px-4 -mt-20 relative z-10 space-y-3.5">
        ...
        <div className="bg-white rounded-2xl card-shadow border border-white/80 overflow-hidden">
          <div className="grid grid-cols-4 gap-2 p-3">
            <Link href="/topup" className="flex min-w-0 flex-col items-center gap-2 py-2 rounded-xl hover:bg-gray-50 transition-colors active:scale-95">
              <div className="w-10 h-10 bg-violet-50 rounded-lg flex items-center justify-center">
                <Zap size={18} className="text-violet-500" />
              </div>
              <span className="text-[9px] font-semibold text-gray-700 text-center leading-tight">Top Up</span>
            </Link>
            <Link href="/qris-kasir" className="flex min-w-0 flex-col items-center gap-2 py-2 rounded-xl hover:bg-gray-50 transition-colors active:scale-95">
            ...
            <Link href="/register-mitra" className="flex min-w-0 flex-col items-center gap-2 py-2 rounded-xl hover:bg-gray-50 transition-colors active:scale-95">
              <div className="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center">
                <UserPlus size={18} className="text-emerald-500" />
              </div>
              <span className="text-[9px] font-semibold text-gray-700 text-center leading-tight">Register</span>
            </Link>
            <Link href="/support" className="flex min-w-0 flex-col items-center gap-2 py-2 rounded-xl hover:bg-gray-50 transition-colors active:scale-95">
